...
// MFCDrawingSystemDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "MFCDrawingSystem.h"
#include "MFCDrawingSystemDlg.h"
...
// CMFCDrawingSystemDlg 对话框



CMFCDrawingSystemDlg::CMFCDrawingSystemDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFCDRAWINGSYSTEM_DIALOG, pParent)
	, LineWidth(0)
	, m_LineType(0)
	, m_text(_T(""))
{
...
void CMFCDrawingSystemDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CMFCDrawingSystemDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCDrawingSystemDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CMFCDrawingSystemDlg::OnBnClickedButton2)
	ON_EN_CHANGE(IDC_EDIT1, &CMFCDrawingSystemDlg::OnEnChangeEdit1)
	ON_BN_CLICKED(IDC_RADIO1, &CMFCDrawingSystemDlg::OnBnClickedRadio1)
	ON_BN_CLICKED(IDC_RADIO2, &CMFCDrawingSystemDlg::OnBnClickedRadio2)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CMFCDrawingSystemDlg::OnCbnSelchangeCombo1)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_CBN_SELCHANGE(IDC_COMBO2, &CMFCDrawingSystemDlg::OnCbnSelchangeCombo2)
	ON_BN_CLICKED(IDC_BUTTON3, &CMFCDrawingSystemDlg::OnBnClickedButton3)
	ON_WM_MOUSEMOVE()
	ON_BN_CLICKED(IDC_BUTTON4, &CMFCDrawingSystemDlg::OnBnClickedButton4)
	ON_BN_CLICKED(IDC_BUTTON5, &CMFCDrawingSystemDlg::OnBnClickedButton5)
	ON_BN_CLICKED(IDC_BUTTON6, &CMFCDrawingSystemDlg::OnBnClickedButton6)
END_MESSAGE_MAP()


// CMFCDrawingSystemDlg 消息处理程序

BOOL CMFCDrawingSystemDlg::OnInitDialog()
{
...
void CMFCDrawingSystemDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCDrawingSystemDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CMFCDrawingSystemDlg::OnQueryDragIcon()
{
...
void CMFCDrawingSystemDlg::OnBnClickedButton1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMFCDrawingSystemDlg::OnBnClickedButton2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMFCDrawingSystemDlg::OnEnChangeEdit1()
{
...
void CMFCDrawingSystemDlg::OnBnClickedRadio1()
{
	// TODO: 在此添加控件通知处理程序代码
	LineType = false;
}
...
void CMFCDrawingSystemDlg::OnBnClickedRadio2()
{
	// TODO: 在此添加控件通知处理程序代码
	LineType = true;
}
...
void CMFCDrawingSystemDlg::OnCbnSelchangeCombo1()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMFCDrawingSystemDlg::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void CMFCDrawingSystemDlg::OnLButtonUp(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值

	//CClientDC dc(this); // 用于绘制的设备上下文
	//dc.MoveTo(DownPoint.x, DownPoint.y);	//先move到起点，（鼠标左键按下的位置）
	//dc.LineTo(point.x, point.y);	//再移动到重点，（鼠标左键送开的位置）
...
void CMFCDrawingSystemDlg::DrawLine()
{
	CClientDC dc(this); // 用于绘制的设备上下文
...
void CMFCDrawingSystemDlg::DrawEllipse()
{
	CClientDC dc(this); // 用于绘制的设备上下文
...
void CMFCDrawingSystemDlg::OnCbnSelchangeCombo2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMFCDrawingSystemDlg::DrawRectangle()
{
...
void CMFCDrawingSystemDlg::OnBnClickedButton3()
{
	// TODO: 在此添加控件通知处理程序代码
	Invalidate();
}
...
void CMFCDrawingSystemDlg::OnMouseMove(UINT nFlags, CPoint point)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
...
void CMFCDrawingSystemDlg::OnBnClickedButton4()
{
	// TODO: 在此添加控件通知处理程序代码
...
void CMFCDrawingSystemDlg::OnBnClickedButton5()
{
	// TODO: 在此添加控件通知处理程序代码
	Mode = ImageMode;
...
void CMFCDrawingSystemDlg::OnBnClickedButton6()
{
	// TODO: 在此添加控件通知处理程序代码
	CClientDC dc(this);
	CRect rect;
